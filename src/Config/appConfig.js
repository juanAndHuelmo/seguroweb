...
export const DEFAULT_APP_CONFIG = {
  ...
  services: {
    ...
    items: [
      {
        title: 'Vehículos',
        icon: asset('/Images/Logos/vehiculo.jpg'),
        image: asset('/Images/fondovehiculo.jpg'),
        description: 'Cotice la cobertura para su vehículo con los mejores beneficios y respaldo.',
      },
      {
        title: 'Hogar',
        icon: asset('/Images/Logos/hogar.jpg'),
        image: asset('/Images/fondohogar.jpg'),
        description: 'Proteja su casa y sus bienes contra todo riesgo con planes a medida.',
      },
      {
        title: 'Comercio',
        icon: asset('/Images/Logos/Empresa.jpg'),
        image: asset('/Images/fondocomercio.jpg'),
        description: 'Acceda a un combinado de coberturas para proteger su negocio e inversión.',
      },
      {
        title: 'Vida',
        icon: asset('/Images/Logos/vida.jpg'),
        image: asset('/Images/fondovida.jpg'),
        description: 'La tranquilidad de saber que el futuro de los suyos está siempre protegido.',
      },
      {
        title: 'Viaje',
        icon: asset('/Images/Logos/viaje.jpg'),
        image: asset('/Images/fondoviaje.jpg'),
